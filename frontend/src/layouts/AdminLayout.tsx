...
import { LayoutDashboard, Users, FileText, LogOut, X, Search, HelpCircle, Bell, UploadCloud, ChevronDown, ChevronUp, UserCheck, BookOpen, User, CheckCircle2, Megaphone, Crown, CreditCard, BookOpenCheck } from 'lucide-react';
...
import { AdminDashboardSkeleton, ArticlesSkeleton, NotificationsSkeleton } from '../components/skeletons/PageSkeletons';
...
const AdminLayout: React.FC<AdminLayoutProps> = ({ isLoadingSkeleton = false }) => {
  ...
  const navItems: any[] = [
    ...
    { name: 'Editorial Board', path: '/admin/editorial-board', icon: BookOpenCheck },
