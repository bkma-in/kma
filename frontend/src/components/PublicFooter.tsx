          ...
          <div className="block md:hidden space-y-6">
            ...
            <div className="space-y-3 text-center sm:text-left flex flex-col items-center sm:items-start">
              ...
              <div className="flex flex-wrap justify-center sm:justify-start gap-2 pt-1">
                ...
                <Link to="/author-guidelines" className="text-[9px] font-black uppercase tracking-widest text-zinc-400 hover:text-white transition-colors border border-white/10 px-2.5 py-1 rounded-md">Author Guidelines</Link>
